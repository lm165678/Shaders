...
//        Geometry grass = markGrass(quad.getWorldTranslation());
        Geometry grass = new GpuGrassGeometry().mark(quad.getWorldTranslation(), 5, 5, 70, 90, assetManager);
        initCamera();
...
//        initShoaw();
    ...
    protected Geometry markGrass(Vector3f location){
        ...
        geometry.setMaterial(new Material(assetManager, "MatDefs/Geom/GrassGeom.j3md"));
